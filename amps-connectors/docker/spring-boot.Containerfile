# ONE shared Containerfile for every connector application.
#
# It can be generic because the build context is generic: the amps.connector-app
...
#
#   ./gradlew :amps-connectors:connector-app:dockerBuildLocal
#   ./gradlew :amps-connectors:apps:<name>:dockerBuildLocal
#
